...
const USER_NOT_FOUND_ERR_MSG = 'Err: User not found';
const MOVIE_NOT_FOUND_ERR_MSG = 'Err: Movie not found';
const PAGE_NOT_FOUND_ERR_MSG = 'Err: Page not found';

const NOT_AUTHORIZED_ERR_MSG = 'Err: Not authorized';

const NO_ACCESS_ERR_MSG = 'Err: no access';
